...
class IntegralData: ExpressionItemData {
    var id: Int
    ...
    override func getDataAsQalculate() -> String {
        ...
        return "integrate(" + mainPart + "; " + bottomPartData.getDataAsQalculate() + "; " + topPartData.getDataAsQalculate() + ")"
    }

    override func getDataAsLatex() -> String {
        return "\\int\\limits_{" + bottomPartData.getDataAsLatex() + "}^{" + topPartData.getDataAsLatex() + "}{" + mainPartData.getDataAsLatex() + "}\\ dx"
    }
