...
class SquareData: ExpressionItemData {
    var id: Int
    ...
    override func getDataAsQalculate() -> String {
        return "(" + bottomPartData.getDataAsQalculate() + ")^(" + topPartData.getDataAsQalculate() + ")"
    }

    override func getDataAsLatex() -> String {
        return "{" + bottomPartData.getDataAsLatex() + "}^{" + topPartData.getDataAsLatex() + "}"
    }

    override func getMaxFractionLevel() -> Int {
        return max(bottomPartData.getMaxFractionLevel(), topPartData.getMaxFractionLevel())
    }
}
