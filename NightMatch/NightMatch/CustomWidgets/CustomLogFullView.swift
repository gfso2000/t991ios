...
struct CustomLogFullView: View {
    @ObservedObject var model: LogFullModel
...
#Preview {
    ...
    return VStack {
        CustomLogFullView(model: LogFullModel(expressionContext: expressionContext, id: 1, showCaret: true, parentModel: ExpressionModel(expressionContext: expressionContext, id: 1, parentModel: nil, fontSize: 20)))
        CustomLogFullView(model: LogFullModel(expressionContext: expressionContext, id: 2, showCaret: false, parentModel: ExpressionModel(expressionContext: expressionContext, id: 2, parentModel: nil, fontSize: 20)))
    }
}
