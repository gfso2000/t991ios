...
struct CustomSquareView: View {
    @ObservedObject var model: SquareModel
...
#Preview {
    ...
    return VStack {
        CustomSquareView(model: SquareModel(expressionContext: expressionContext, id: 1, showCaret: true, parentModel: ExpressionModel(expressionContext: expressionContext, id: 1, parentModel: nil, fontSize: 20)))
        CustomSquareView(model: SquareModel(expressionContext: expressionContext, id: 2, showCaret: false, parentModel: ExpressionModel(expressionContext: expressionContext, id: 2, parentModel: nil, fontSize: 20)))
    }
}
